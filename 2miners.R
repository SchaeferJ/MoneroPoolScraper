...
# General Setup
POOL_NAME <- "2miners"
POOL_URL <- "https://xmr.2miners.com/"
POOL_ID <- 1 # For Worker UIDS

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://xmr.2miners.com/api/blocks"
ACTIVEMINER_ENDPOINT <- "https://xmr.2miners.com/api/miners"
MINERDETAILS_ENDPOINT <- "https://xmr.2miners.com/api/accounts/"
PAYMENT_ENDPOINT <- "https://xmr.2miners.com/api/payments"
