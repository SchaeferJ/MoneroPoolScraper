...
# General Setup
POOL_NAME <- "Bohemian Pool"
POOL_URL <- "https://bohemianpool.com/"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://bohemianpool.com/api/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://bohemianpool.com/api/pool/payments?page=%i&limit=%i"
