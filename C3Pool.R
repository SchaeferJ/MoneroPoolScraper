...
# General Setup
POOL_NAME <- "C3Pool"
POOL_URL <- "https://c3pool.com/"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://api.c3pool.com/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://api.c3pool.com/pool/payments?page=%i&limit=%i"
