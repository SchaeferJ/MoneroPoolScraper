...
POOL_URL <- "https://monero.crypto-pool.fr"

# Define API-Endpoints to query
STATS_ENDPOINT <- "https://monero.crypto-pool.fr:8091/stats"
BLOCKS_ENDPOINT <- "https://monero.crypto-pool.fr:8091/get_blocks?height="
PAYMENT_ENDPOINT <- "https://monero.crypto-pool.fr:8091/get_payments?time="
