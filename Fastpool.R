...
# General Setup
POOL_NAME <- "Fastpool"
POOL_URL <- "https://fastpool.xyz"

# Define API-Endpoints to query
STATS_ENDPOINT <- "https://fastpool.xyz/api-xmr/stats"
BLOCKS_ENDPOINT <- "https://fastpool.xyz/api-xmr/get_blocks?height="
PAYMENT_ENDPOINT <- "https://fastpool.xyz/api-xmr/get_payments?time="
