...
# General Setup
POOL_NAME <- "LibertyPool"
POOL_URL <- "https://liberty-pool.com"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://api.liberty-pool.com/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://api.liberty-pool.com/pool/payments?page=%i&limit=%i"
