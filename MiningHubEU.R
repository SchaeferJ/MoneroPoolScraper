...
# General Setup
POOL_NAME <- "MiningHub.eu"
POOL_URL <- "https://xmr.mininghub.eu/"

# Define API-Endpoints to query
STATS_ENDPOINT <- "https://stratum.xmr.mininghub.eu:8119/stats"
BLOCKS_ENDPOINT <- "https://stratum.xmr.mininghub.eu:8119/get_blocks?height="
PAYMENT_ENDPOINT <- "https://stratum.xmr.mininghub.eu:8119/get_payments?time="
...
blockList[[1]] <- process_blockstring(poolStats[["pool"]][["blocks"]], skip=2)
...
while (TRUE) {
  ...
  minedBlocks <- process_blockstring(minedBlocks, skip = 2)
