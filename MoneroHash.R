...
# General Setup
POOL_NAME <- "MoneroHash"
POOL_URL <- "https://monerohash.com"
POOL_ID <- 5 # For Worker UIDS

# Define API-Endpoints to query
STATS_ENDPOINT <- "https://monerohash.com/api/live_stats"
BLOCKS_ENDPOINT <- "https://monerohash.com/api/get_blocks?height="
PAYMENT_ENDPOINT <- "https://monerohash.com/api/get_payments?time="
MINER_ENDPOINT <- "https://monerohash.com/api/stats_address?address=%s&longpoll=false"
PAYOUT_ENDPOINT <- "https://monerohash.com/api/get_payments?time=%i&address=%s"
...
paymentList <- paymentList[paymentList$Date > lastKnownPayout, ]
