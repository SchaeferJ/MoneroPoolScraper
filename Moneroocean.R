...
POOL_URL <- "https://moneroocean.stream/"
...
BLOCKS_ENDPOINT <- "https://api.moneroocean.stream/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://api.moneroocean.stream/pool/payments?page=%i&limit=%i"
