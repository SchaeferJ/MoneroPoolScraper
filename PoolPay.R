...
# General Setup
POOL_NAME <- "Pool Pay"
POOL_URL <- "https://xmr.pool-pay.com"

# Define API-Endpoints to query
STATS_ENDPOINT <- "https://xmr.pool-pay.com:8129/stats"
BLOCKS_ENDPOINT <- "https://xmr.pool-pay.com:8129/get_blocks?height="
PAYMENT_ENDPOINT <- "https://xmr.pool-pay.com:8129/get_payments?time="
