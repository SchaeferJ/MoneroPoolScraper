...
# General Setup
POOL_NAME <- "pool.xmr.pt"
POOL_URL <- "https://pool.xmr.pt"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://test.xmr.pt/api/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://test.xmr.pt/api/pool/payments?page=%i&limit=%i"
