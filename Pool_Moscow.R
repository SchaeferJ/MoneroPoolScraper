...
# General Setup
POOL_NAME <- "Pool Moscow"
POOL_URL <- "https://monero.pool-moscow.ru"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://monero.pool-moscow.ru/api/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://monero.pool-moscow.ru/api/pool/payments?page=%i&limit=%i"
