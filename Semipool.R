...
# General Setup
POOL_NAME <- "Semipool"
POOL_URL <- "https://webxmr.semipool.com"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://webxmr.semipool.com/api/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://webxmr.semipool.com/api/pool/payments?page=%i&limit=%i"
