...
# General Setup
POOL_NAME <- "Skypool"
POOL_URL <- "https://cpu.skypool.org"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://api.skypool.xyz/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://api.skypool.xyz/pool/payments?page=%i&limit=%i"
