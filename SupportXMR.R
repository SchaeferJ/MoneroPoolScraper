...
POOL_URL <- "https://www.supportxmr.com/"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://supportxmr.com/api/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://supportxmr.com/api/pool/payments?page=%i&limit=%i"
