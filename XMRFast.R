...
# General Setup
POOL_NAME <- "XMRFast"
POOL_URL <- "https://xmrfast.com/"

# Define API-Endpoints to query
BLOCKS_ENDPOINT <- "https://xmrfast.com//api/pool/blocks?page=%i&limit=%i"
PAYMENT_ENDPOINT <- "https://xmrfast.com//api/pool/payments?page=%i&limit=%i"
