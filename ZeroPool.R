...
# General Setup
POOL_NAME <- "ZeroPool"
POOL_URL <- "https://xmr.zeropool.io/"

# Define API-Endpoints to query
STATS_ENDPOINT <- "https://xmr.zeropool.io:8119/stats"
BLOCKS_ENDPOINT <- "https://xmr.zeropool.io:8119/get_blocks?height="
PAYMENT_ENDPOINT <- "https://xmr.zeropool.io:8119/get_payments?time="
